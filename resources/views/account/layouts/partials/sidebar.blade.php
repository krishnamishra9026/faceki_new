    ...
    <div class="scrollbar-inner">
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link{{ return_if(on_page('account.tokens.index'), ' active') }}" href="#navbar-maps" data-toggle="collapse" role="button"
                            ...
                            <span class="nav-link-text">Generate API</span>
                        </a>
                ...
                https://saas-demo.creatydev.com/docs-->
                <h6 class="navbar-heading p-0 text-muted">API DOCUMENTATION</h6>
                <!-- Navigation -->
                <ul class="navbar-nav mb-md-3">
                    <li class="nav-item">
                        <a class="nav-link"
                            href="https://faceki.docs.apiary.io/#introduction/help-and-support" target="blank__"
                            target="_blank">
